...
export type DynCompList<T> = CompList<T> | ((...args: any[]) => CompList<T>);
...
export type GameObj<T> = GameObjRaw & MergeComps<T>;
...
declare global {
	...
	const colLineLine: KaboomCtx["colLineLine"];
	const colRectRect: KaboomCtx["colRectRect"];
	/**
	 * Define a scene.
	 */
	...
	const drawRectStroke: KaboomCtx["drawRectStroke"];
